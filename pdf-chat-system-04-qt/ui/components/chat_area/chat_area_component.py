# ui/components/chat_area/chat_area_component.py

from PyQt6.QtWidgets import QWidget, QVBoxLayout, QScrollArea
from PyQt6.QtCore import Qt

from ui.components.chat_area.widgets.placeholder_widget import PlaceholderWidget
from ui.components.chat_area.widgets.message_bubble_widget import MessageBubbleWidget


class ChatAreaComponent(QWidget):
    """
    Scrollable list of message bubbles with an empty-state placeholder.
    Dumb renderer; all operations are driven by ChatAreaController.
    """
    ...
    # --- Public operations (called by ChatAreaController) ---
    ...
    # --- Internal helpers (one task each) ---

    def _remove_all_bubbles(self):
    ...
    def _scroll_to_bottom(self):
        ...
        def on_range_changed(min_value, max_value):
