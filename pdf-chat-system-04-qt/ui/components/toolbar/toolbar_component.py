# ui/components/toolbar/toolbar_component.py

from PyQt6.QtWidgets import QWidget, QHBoxLayout
from PyQt6.QtCore import pyqtSignal

from ui.components.toolbar.widgets.upload_button_widget import UploadButtonWidget
from ui.components.toolbar.widgets.filename_label_widget import FilenameLabelWidget
from ui.components.toolbar.widgets.clear_button_widget import ClearButtonWidget
from ui.components.toolbar.widgets.theme_combo_widget import ThemeComboWidget


class ToolbarComponent(QWidget):
    """
    Composes all toolbar widgets.
    Single responsibility: wire children together and expose clean signals upward.
    """
    ...
    # --- Public operations (called by ToolbarController) ---
