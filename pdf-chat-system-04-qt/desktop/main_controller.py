...
class MainController:
    ...
    and the event handlers, then wires every component signal to a handler
    method. It contains no business logic and never manipulates widgets
    directly — UI work goes through the ScreenManager and controllers.
    """
    ...
    def _create_event_handlers(self):
        ...
        self._toolbar_handler = ToolbarEventHandler(
            actions, ui.file_picker, ui.toolbar, ui.chat_area, ui.input_bar, ui.status_bar,
        )
